...
export default function AdminSidebar({ activeTab, onSelectTab, sidebarOpen, onToggleSidebar }: AdminSidebarProps) {
  return (
    <>
      ...
      <aside className={`fixed lg:static left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 transform transition-transform duration-200 z-40 lg:translate-x-0 lg:z-0 ${
        sidebarOpen ? 'translate-x-0' : '-translate-x-full'
      }`}>
        <div className="p-6 space-y-8">
          <button onClick={onToggleSidebar} className="lg:hidden absolute right-4 top-4 p-2 hover:bg-gray-100 rounded-lg">
            <X size={20} />
          </button>
          ...
          <div className="flex items-center gap-3 mt-4 lg:mt-0">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">BiteWise</h2>
          ...
          <div className="border-t border-gray-200 pt-4">
            <p className="text-xs text-gray-400 font-semibold mb-3">Delicious Food, Smartly Delivered</p>
